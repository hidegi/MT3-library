...
#define SP_ASSERT_DECIMAL_GREATER(a, b) SP_ASSERT_DECIMAL_GREATER_WITH_ACTION(a, b, ;)
#define SP_ASSERT_DECIMAL_GREATER_EQUAL(a, b) SP_ASSERT_DECIMAL_GREATER_EQUAL_WITH_ACTION(a, b, ;)
#define SP_ASSERT_DECIMAL_LESS(a, b) SP_ASSERT_DECIMAL_LESS_WITH_ACTION(a, b, ;)
#define SP_ASSERT_DECIMAL_LESS_EQUAL(a, b) SP_ASSERT_DECIMAL_LESS_EQUAL_WITH_ACTION(a, b, ;)
#define SP_ASSERT_DECIMAL_ALMOST_EQUAL(a, b, n) SP_ASSERT_DECIMAL_ALMOST_EQUAL_WITH_ACTION(a, b, n, ;)
#define SP_ASSERT_DECIMAL_ALMOST_NOT_EQUAL(a, b, n) SP_ASSERT_DECIMAL_ALMOST_NOT_EQUAL_WITH_ACTION(a, b, n, ;)
#endif
