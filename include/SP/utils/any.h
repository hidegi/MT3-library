#ifndef SP_ANY_H_INCLUDED
#define SP_ANY_H_INCLUDED
#include "SP/config.h"
...
class SP_API bad_any_cast : public std::bad_cast
{
public:
...
namespace std
{
	inline void swap(sp::Any& lhs, sp::Any& rhs) noexcept
	{
		lhs.swap(rhs);
	}
}
